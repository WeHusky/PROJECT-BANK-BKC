...
<body class="bg-white font-sans mb-20">
 ...
 <div class="menu px-6">
  ...
  <a href="{{ route('nasabah.loan.application') }}">
    <div class="bg-gray-100 border border-gray-200 rounded-[27px] w-full flex items-center py-2 px-6 mb-5 active:bg-gray-200 transition-all duration-200 ease-in-out">
