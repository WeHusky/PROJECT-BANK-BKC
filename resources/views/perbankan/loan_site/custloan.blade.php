...
<div class="bg-gray-100 min-h-screen pt-4 px-4 pb-28">
  <!-- Header -->
    <div class="flex items-center space-x-2 mb-6">
        <a href="{{ route('homepage') }}" class="text-cyan-600">
            <img class="w-[22px] h-[22px]" src="{{ asset('images/arrowblue.png') }}" alt="Arrow">
        </a>
        <h1 class="text-2xl font-bold" style="color: #13545C;">Loan</h1>
    </div>
